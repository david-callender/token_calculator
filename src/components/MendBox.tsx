...
export const MendBox: FC<Props> = ({ entry, state }) => {
    ...
    return <>
        ...
        <div onClick={() => {setToggled(!toggled)}} className="rounded-xl m-2 place-self-center flex p-5 pl-2 shadow-xl hover:-translate-y-1 transition-all w-1/2 font-serif bg-foreground">
